...
json.concert order_concert ? ( json.partial! "pai/v1/concerts/concert", {concert: order_concert} ) : ""
order_stadium = Stadium.where(id: order.stadium_id).first
json.stadium order_stadium ? ( json.partial! "pai/v1/stadiums/stadium", {stadium: order_stadium} ) : ""
order_city = City.where(id: order.city_id).first
json.city order_city ? ( json.partial! "pai/v1/cities/city", {city: order_city} ) : ""
