...
json.voters_count ( UserVoteConcert.where(concert_id: show.concert_id, city_id: show.city_id).count + ConcertCityRelation.where(concert_id: show.concert_id, city_id: show.city_id).first.base_number)
