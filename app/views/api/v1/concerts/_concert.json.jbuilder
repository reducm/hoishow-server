...
json.(concert, :id, :name, :status, :followers_count, :shows_count, :voters_count)
...
json.voted_city @voted_concert ? ( json.partial! "api/v1/cities/city", city: City.find(@voted_concert.city_id)  ): ""
if need_stars
